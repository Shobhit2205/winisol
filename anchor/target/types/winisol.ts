...
export type Winisol = {
  ...
  "instructions": [
    ...
    {
      "name": "claimLimitedLotteryWinnings",
      "discriminator": [
        242,
        239,
        109,
    ...
    {
      "name": "commitLimitedLotteryRandomness",
      "discriminator": [
        44,
        200,
        223,
    ...
    {
      "name": "initializeLimitedLotteryConfig",
      "discriminator": [
        100,
        12,
        239,
    ...
    {
      "name": "limitedLotteryTransferToAuthority",
      "discriminator": [
        216,
        153,
        78,
    ...
    {
      "name": "revealLimitedLotteryWinner",
      "discriminator": [
        113,
        44,
        56,
  ...
  "types": [
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "winnerClaimedWinnings",
            "type": "bool"
          },
          {
            "name": "authorityClaimedShare",
            "type": "bool"
          },
          {
            "name": "randomnessAccount",
  ...
  "constants": [
    {
      "name": "authority",
      "type": "string",
      "value": "\"RJtnLDyB6pZUWDZ7qZE8nCakas6eaofnqKyBDB7Xf1A\""
    }
  ]
};
