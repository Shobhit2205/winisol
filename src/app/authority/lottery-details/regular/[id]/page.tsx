...
export default function Page() {
    ...
    const lottery = lotteries.find((lottery: any) => lottery.id === parseInt(lotteryId));
    ...
    return (
        <AuthorityLotteryDetails lottery={lottery} isLotteryLoading={isLotteriesLoading} lotteryType="regular" />
    );
}